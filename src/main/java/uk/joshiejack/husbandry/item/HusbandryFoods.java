...
public class HusbandryFoods {
    ...
    public static final Food MUG_OF_MILK = new Food.Builder().nutrition(2).saturationMod(0.1F).build();
    public static final Food HOT_MILK = new Food.Builder().nutrition(3).saturationMod(0.2F).build();
    public static final Food TRUFFLE = new Food.Builder().nutrition(4).saturationMod(0.6F).build();
}
